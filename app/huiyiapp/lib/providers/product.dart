...
class ProductProvider with ChangeNotifier {
  ...
  List<Product> _items = [
    ...
    Product(
        ...
        title: "筆",
        description:
            "這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆這是一支筆",
        price: 44,
        imageURL:
